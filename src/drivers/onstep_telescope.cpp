...
namespace onst = onstep_commands;
namespace onsr = onstep_responses;

std::vector<std::string> onstep_telescope::serial_devices() {
  std::vector<std::string> serial_devices{
      "/dev/serial/by-id/usb-Silicon_Labs_CP2102N_USB_to_UART_Bridge_Controller_1adcd4a73f1bef11bcb917764909ffd0-if00-port0"  
      };
...
std::string onstep_telescope::unique_id() {
  return "usb-OnStep_Mount_123456-if00";
}

bool onstep_telescope::connected() { return _connected; }

int onstep_telescope::set_connected(bool connected) {
  ...
  if (connected) {
    try {
      ...
      _serial_port.write_some(asio::buffer(onst::cmd_get_status()));
      ...
      auto resp = send_command_to_mount(onst::cmd_get_tracking_status());
      if (resp == "1#")
...
onstep_telescope::onstep_telescope()
...
void onstep_telescope::throw_if_not_connected() {
  if (!_connected)
    throw alpaca_exception(alpaca_exception::NOT_CONNECTED,
                           "Mount not connected");
}

void onstep_telescope::throw_if_parked() {
  if (_parked)
    throw alpaca_exception(alpaca_exception::INVALID_OPERATION,
                           "Mount is parked");
}

std::string onstep_telescope::send_command_to_mount(const std::string &cmd,
                                                     bool read_response,
                                                     char stop_on_char) {
  try {
...
uint32_t onstep_telescope::interface_version() { return 3; }

std::string onstep_telescope::driver_version() { return "v0.1"; }

std::string onstep_telescope::description() {
  return "OnStep Telescope Driver";
}

std::string onstep_telescope::driverinfo() {
  return "OnStep Telescope Driver Information";
}

std::string onstep_telescope::name() { return "OnStep Mount"; };

std::vector<std::string> onstep_telescope::supported_actions() {
...
// sense.
alignment_mode_enum onstep_telescope::alignment_mode() {
  return alignment_mode_enum::polar;
}

double onstep_telescope::altitude() {
  throw_if_not_connected();

  std::string resp = send_command_to_mount(onst::cmd_get_altitude());
  onsr::sdd_mm_ss result = onsr::parse_sdd_mm_ss_response(resp);

  return result.as_decimal();
}

double onstep_telescope::aperture_diameter() { return _aperture_diameter; }

int onstep_telescope::set_aperture_diameter(const double &diameter) {
  _aperture_diameter = diameter;
  return 0;
};

double onstep_telescope::aperture_area() {
  throw_if_not_connected();
...
bool onstep_telescope::slewing() {
  if (_moving)
    return true;
  auto resp = send_command_to_mount(onst::cmd_get_status());
...
bool onstep_telescope::at_home() {
  throw_if_not_connected();
  std::string resp = send_command_to_mount(onst::cmd_get_status());
...
// TODO: implement
bool onstep_telescope::at_park() {
  throw_if_not_connected();
  return _parked;
}

// TODO: implement
double onstep_telescope::azimuth() {
  throw_if_not_connected();
  std::string resp = send_command_to_mount(onst::cmd_get_azimuth());
  spdlog::trace("raw value returned from mount for cmd_get_azimuth(): {0}",
                resp);
  return onsr::parse_ddd_mm_ss_response(resp).as_decimal();
}

// AM5 supports finding home
bool onstep_telescope::can_find_home() {
  throw_if_not_connected();
  return true;
}

// AM5 supports park
bool onstep_telescope::can_park() {
  throw_if_not_connected();
  return true;
}

// AM5 supports pulse guiding
bool onstep_telescope::can_pulse_guide() {
  throw_if_not_connected();
  return true;
}

// AM5 supports setting rates
bool onstep_telescope::can_set_declination_rate() {
  throw_if_not_connected();
  return false;
}

// AM5 supports setting guide rates
bool onstep_telescope::can_set_guide_rates() {
  throw_if_not_connected();
  return true;
}

// AM5 doesn't appear to support a custom park
bool onstep_telescope::can_set_park() {
  throw_if_not_connected();
  return false;
}
...
//
bool onstep_telescope::can_set_pier_side() {
  throw_if_not_connected();
  return false;
}

// AM5 supports setting rates
bool onstep_telescope::can_set_right_ascension_rate() {
  throw_if_not_connected();
  return false;
}

// AM5 supports turning tracking on and off
bool onstep_telescope::can_set_tracking() {
  throw_if_not_connected();
  return true;
}

bool onstep_telescope::can_slew() {
  throw_if_not_connected();
  return true;
}

bool onstep_telescope::can_slew_async() {
  throw_if_not_connected();
  return true;
}

// TODO: decide whether or not I'm gonna implement alt az mode
bool onstep_telescope::can_slew_alt_az() {
  throw_if_not_connected();
  return false;
}

// TODO: decide whether or not I'm gonna implement alt az mode
bool onstep_telescope::can_slew_alt_az_async() {
  throw_if_not_connected();
  return false;
}

bool onstep_telescope::can_sync() {
  throw_if_not_connected();
  return true;
}

// I don't believe this is supported according to AM5 documentation
bool onstep_telescope::can_sync_alt_az() {
  throw_if_not_connected();
  return false;
}

// The mount doesn't support this natively, so we will emulate
bool onstep_telescope::can_unpark() {
  throw_if_not_connected();
  return true;
}

double onstep_telescope::declination() {
  throw_if_not_connected();
  std::string resp = send_command_to_mount(onst::cmd_get_current_dec());
  spdlog::trace("declination returned: {0}", resp);
  auto parsed_resp = onsr::parse_sdd_mm_ss_response(resp);
...
double onstep_telescope::declination_rate() {
  throw_if_not_connected();
  return 0;
}

// not supported
int onstep_telescope::set_declination_rate(const double &) {
  throw_if_not_connected();
  throw alpaca_exception(alpaca_exception::NOT_IMPLEMENTED,
...
bool onstep_telescope::does_refraction() {
  throw_if_not_connected();
  return false;
}

int onstep_telescope::set_does_refraction(bool) {
  throw_if_not_connected();
  throw alpaca_exception(alpaca_exception::NOT_IMPLEMENTED,
...
equatorial_system_enum onstep_telescope::equatorial_system() {
  throw_if_not_connected();
  return equatorial_system_enum::topocentric;
}

double onstep_telescope::focal_length() {
  throw_if_not_connected();
  return _focal_length;
}

int onstep_telescope::set_focal_length(const double &focal_length) {
  throw_if_not_connected();
...
double onstep_telescope::guide_rate_declination() {
  throw_if_not_connected();
  auto resp = send_command_to_mount(onst::cmd_get_guide_rate());
  std::string value = resp.substr(0, 3);
  auto rate_in_degrees_per_second = atof(&value[0]) * .0042;
  return rate_in_degrees_per_second;
}

int onstep_telescope::set_guide_rate_declination(const double &rate) {
  throw_if_not_connected();
  spdlog::debug("set_guide_rate_declination called with {} converted to {}",
                rate, rate / .0042);
  send_command_to_mount(onst::cmd_set_guide_rate(rate / .0042), false);
  return 0;
}

// We just use the same method as declination
double onstep_telescope::guide_rate_ascension() {
  return guide_rate_declination();
}

// We just use the same method as declination
int onstep_telescope::set_guide_rate_ascension(const double &rate) {
  return set_guide_rate_declination(rate);
}

bool onstep_telescope::is_pulse_guiding() {
  spdlog::trace("is_pulse_guiding() invoked");
  return _is_pulse_guiding;
}

double onstep_telescope::right_ascension() {
  throw_if_not_connected();
  spdlog::trace("right_ascension() invoked");
  std::string resp = send_command_to_mount(onst::cmd_get_current_ra());
  spdlog::trace("ra returned: {0}", resp);
  auto parsed_resp = onsr::parse_hh_mm_ss_response(resp);
...
// separte RA rate
double onstep_telescope::right_ascension_rate() { return 0; }

int onstep_telescope::set_right_ascension_rate(const double &) {
  throw alpaca_exception(alpaca_exception::NOT_IMPLEMENTED,
...
pier_side_enum onstep_telescope::side_of_pier() {
  throw_if_not_connected();
  spdlog::trace("side_of_pier invoked");
  std::string resp =
      send_command_to_mount(onst::cmd_get_current_cardinal_direction());
...
int onstep_telescope::set_side_of_pier(const pier_side_enum &) {
  throw alpaca_exception(alpaca_exception::NOT_IMPLEMENTED,
                         "Setting side of pier not supported on this mount");
  return 0;
}

double onstep_telescope::sidereal_time() {
  throw_if_not_connected();
  auto resp = send_command_to_mount(onst::cmd_get_sidereal_time());
  auto sidereal_data = onsr::parse_hh_mm_ss_response(resp);
  return sidereal_data.as_decimal();
}

double onstep_telescope::site_elevation() {
  throw_if_not_connected();
  return _site_elevation;
}

// TODO: add some validation
int onstep_telescope::set_site_elevation(const double &site_elevation) {
  throw_if_not_connected();
...
double onstep_telescope::site_latitude() {
  throw_if_not_connected();
  auto resp = send_command_to_mount(onst::cmd_get_latitude());
  auto parsed_resp = onsr::parse_sdd_mm_ss_response(resp);
...
// TODO: add some validation
int onstep_telescope::set_site_latitude(const double &site_latitude) {
  throw_if_not_connected();
  ...
  onsr::sdd_mm_ss latitude_s(site_latitude);

  spdlog::debug(" converts to {}", latitude_s);
  auto resp = send_command_to_mount(
      onst::cmd_set_latitude(latitude_s.plus_or_minus, latitude_s.dd,
...
double onstep_telescope::site_longitude() {
  throw_if_not_connected();
  auto resp = send_command_to_mount(onst::cmd_get_longitude());
  auto parsed_resp = onsr::parse_sddd_mm_ss_response(resp);
...
// TODO: add some validation
int onstep_telescope::set_site_longitude(const double &site_longitude) {
  throw_if_not_connected();
  ...
  onsr::sddd_mm_ss longitude_s(site_longitude);
  ...
  if (longitude_s.plus_or_minus == '+')
    ...
    longitude_s.plus_or_minus = '+';
  auto resp = send_command_to_mount(
      onst::cmd_set_longitude(longitude_s.plus_or_minus, longitude_s.ddd,
...
int onstep_telescope::slew_settle_time() {
  throw_if_not_connected();
  return _slew_settle_time;
}

// TODO: add some validation
int onstep_telescope::set_slew_settle_time(const int &slew_settle_time) {
  throw_if_not_connected();
...
// sdd_mm_ss
double onstep_telescope::target_declination() {
  throw_if_not_connected();
  if (!_dec_target_set)
    throw alpaca_exception(alpaca_exception::INVALID_OPERATION,
                           "Must set DEC target before reading");

  auto resp = send_command_to_mount(onst::cmd_get_target_dec());
  double val = onsr::parse_sdd_mm_ss_response(resp).as_decimal();
  return val;
}

// sdd_mm_ss
int onstep_telescope::set_target_declination(const double &dec) {
  throw_if_not_connected();
  onsr::sdd_mm_ss converted(dec);
  auto resp = send_command_to_mount(
      onst::cmd_set_target_dec(converted.plus_or_minus, converted.dd,
...
// hh_mm_ss
double onstep_telescope::target_right_ascension() {
  throw_if_not_connected();
  if (!_ra_target_set)
    throw alpaca_exception(alpaca_exception::INVALID_OPERATION,
                           "Must set RA target before reading");
  auto resp = send_command_to_mount(onst::cmd_get_target_ra());
  double val = onsr::parse_hh_mm_ss_response(resp).as_decimal();
  return val;
}

// hh_mm_ss
int onstep_telescope::set_target_right_ascension(const double &ra) {
  throw_if_not_connected();
  onsr::hh_mm_ss converted(ra);
  auto resp = send_command_to_mount(
      onst::cmd_set_target_ra(converted.hh, converted.mm, converted.ss), true,
      '\0');
  if (resp == "1") {
    _ra_target_set = true;
    return 0;
...
bool onstep_telescope::tracking() {
  throw_if_not_connected();
...
int onstep_telescope::set_tracking(const bool &tracking) {
  ...
  if (tracking)
    resp = send_command_to_mount(onst::cmd_start_tracking(), true, '\0');
  else
    resp = send_command_to_mount(onst::cmd_stop_tracking(), true, '\0');
  if (resp == "1") {
    _tracking_enabled = tracking;
    return 0;
  } else {
    auto gat_resp = send_command_to_mount(onst::cmd_get_tracking_status());
    ...
    if (gat_resp == "0#" && tracking) {
      ...
      if (resp == "1") {
        ...
        gat_resp = send_command_to_mount(onst::cmd_get_tracking_status());
        if (gat_resp == "1#") {
...
drive_rate_enum onstep_telescope::tracking_rate() {
  auto resp = send_command_to_mount(onst::cmd_get_tracking_rate());
  return static_cast<drive_rate_enum>(onsr::parse_standard_response(resp));
}

int onstep_telescope::set_tracking_rate(const drive_rate_enum &tracking_rate) {
  throw_if_not_connected();
  switch (tracking_rate) {
  case drive_rate_enum::sidereal:
    send_command_to_mount(onst::cmd_set_tracking_rate_to_sidereal(), false);
    break;
  case drive_rate_enum::solar:
    send_command_to_mount(onst::cmd_set_tracking_rate_to_solar(), false);
    break;
  case drive_rate_enum::lunar:
    send_command_to_mount(onst::cmd_set_tracking_rate_to_lunar(), false);
    break;
  default:
    throw alpaca_exception(
...
std::vector<drive_rate_enum> onstep_telescope::tracking_rates() {
  throw_if_not_connected();
...
// TODO: implement
std::string onstep_telescope::utc_date() {
  throw_if_not_connected();

  using namespace std::chrono_literals;

//   auto raw_resp_t = send_command_to_mount(onst::cmd_get_date_and_time_and_tz());
//   spdlog::trace("raw data from scope: {}", raw_resp_t);

  auto tz_resp = send_command_to_mount(onst::cmd_get_timezone());
  onsr::shh_mm tz_data = onsr::parse_shh_mm_response(tz_resp);

//   auto dst_resp = send_command_to_mount(onst::cmd_get_daylight_savings());
//   int d_savings = onsr::parse_standard_response(dst_resp);

//   spdlog::trace("mount believes daylight savings is: {}", d_savings);

  auto date_resp = send_command_to_mount(onst::cmd_get_date());
  onsr::mm_dd_yy date_data = onsr::parse_mm_dd_yy_response(date_resp);

  auto time_resp = send_command_to_mount(onst::cmd_get_time());
  onsr::hh_mm_ss time_data = onsr::parse_hh_mm_ss_response(time_resp);
...
// Expects format like:
//  2016-03-04T17:45:31.1234567Z
int onstep_telescope::set_utc_date(const std::string &utc_date_str) {
  throw_if_not_connected();
  using namespace std::chrono_literals;
  ...
  // Set DST to 0
  send_command_to_mount(onst::cmd_set_daylight_savings(0), true, '\0');
  ...
  auto resp = send_command_to_mount(
      onst::cmd_set_timezone(plus_or_minus_tz, tz_hh), true, '\0');
  if (resp != "1")
    throw alpaca_exception(alpaca_exception::DRIVER_ERROR,
                           "Problem setting date with driver");

  resp = send_command_to_mount(onst::cmd_set_date(date_mm, date_dd, date_yy),
                               true, '\0');
  if (resp != "1")
    throw alpaca_exception(alpaca_exception::DRIVER_ERROR,
                           "Problem setting date with driver");

  resp = send_command_to_mount(onst::cmd_set_time(time_hh, time_mm, time_ss),
                               true, '\0');
  if (resp != "1")
    throw alpaca_exception(alpaca_exception::DRIVER_ERROR,
...
//                 send_command_to_mount(onst::cmd_get_date_and_time_and_tz()));
  spdlog::trace("sidereal time from mount: {}",
                send_command_to_mount(onst::cmd_get_sidereal_time()));

  return 0;
}

int onstep_telescope::abort_slew() {
  throw_if_not_connected();
  throw_if_parked();
  spdlog::debug("abort_slew() invoked");
  send_command_to_mount(onst::cmd_stop_moving(), false);
  return 0;
}

std::vector<axis_rate>
onstep_telescope::axis_rates(const telescope_axes_enum &axis) {
  throw_if_not_connected();
...
bool onstep_telescope::can_move_axis(const telescope_axes_enum &axis) {
  throw_if_not_connected();
  if (axis == telescope_axes_enum::primary)
    return true;
...
pier_side_enum onstep_telescope::destination_side_of_pier(const double &ra,
                                                           const double &dec) {
  throw_if_not_connected();
  throw alpaca_exception(alpaca_exception::NOT_IMPLEMENTED,
...
class blocking_telescope_command {
  ...
  onstep_telescope &_telescope;
  bool _is_done_moving;

public:
  blocking_telescope_command(onstep_telescope &telescope)
...
void onstep_telescope::block_while_moving() {
  using namespace std::chrono_literals;
...
int onstep_telescope::find_home() {
  using namespace std::chrono_literals;
  throw_if_not_connected();
  throw_if_parked();
  spdlog::debug("find_home invoked");
  send_command_to_mount(onst::cmd_home_position(), false);
  // block_while_moving();
...
void onstep_telescope::set_is_moving(bool is_moving) {
  std::lock_guard lock(_moving_mtx);
  _moving = is_moving;
};

// I'm making an assumption that east/west is mapped to RA...need to test
int onstep_telescope::move_axis(const telescope_axes_enum &axis,
                                 const double &rate) {
  ...
  case telescope_axes_enum::primary:
    ...
    send_command_to_mount(
        onst::cmd_set_moving_speed_precise(std::abs(rate) / .0042), false);
    if (rate > 0)
      send_command_to_mount(onst::cmd_move_towards_east(), false);
    else if (rate < 0)
      send_command_to_mount(onst::cmd_move_towards_west(), false);
    else {
      set_is_moving(false);
      send_command_to_mount(onst::cmd_stop_moving_towards_east(), false);
      send_command_to_mount(onst::cmd_stop_moving_towards_west(), false);
    }
    break;
  // Dec
  case telescope_axes_enum::secondary:
    ...
    send_command_to_mount(
        onst::cmd_set_moving_speed_precise(std::abs(rate) / .0042), false);
    if (rate > 0)
      send_command_to_mount(onst::cmd_move_towards_north(), false);
    else if (rate < 0)
      send_command_to_mount(onst::cmd_move_towards_south(), false);
    else {
      set_is_moving(false);
      send_command_to_mount(onst::cmd_stop_moving_towards_south(), false);
      send_command_to_mount(onst::cmd_stop_moving_towards_north(), false);
    }
    break;
  default:
    throw alpaca_exception(alpaca_exception::INVALID_VALUE,
...
void onstep_telescope::pulse_guide_proc(int duration_ms,
  ...
  if (remaining_duration_ms > 3000) {
    ...
    for (int i = 0; i < count; i++) {
      ...
      send_command_to_mount(onst::cmd_guide(cardinal_direction, 3000), false);
      std::this_thread::sleep_for(std::chrono::milliseconds(3000));
    }
  }

  send_command_to_mount(
      onst::cmd_guide(cardinal_direction, remaining_duration_ms), false);
...
// will drift in RA.
void onstep_telescope::pulse_guide_proc_using_move(int duration_ms,
                                                    char cardinal_direction) {
  ...
  send_command_to_mount(onst::cmd_set_0_5x_sidereal_rate(), false);
...
//  makes sense
int onstep_telescope::pulse_guide(const guide_direction_enum &direction,
  ...
  _guiding_thread =
      std::thread(std::bind(&onstep_telescope::pulse_guide_proc, this,
...
int onstep_telescope::slew_to_alt_az(const double &alt, const double &az) {
  throw_if_not_connected();
  throw_if_parked();
  throw alpaca_exception(alpaca_exception::NOT_IMPLEMENTED,
...
int onstep_telescope::slew_to_alt_az_async(const double &alt,
                                            const double &az) {
  throw_if_not_connected();
  throw_if_parked();
  throw alpaca_exception(alpaca_exception::NOT_IMPLEMENTED,
...
int onstep_telescope::slew_to_coordinates(const double &ra,
                                           const double &dec) {
  throw_if_not_connected();
  throw_if_parked();
  ...
  onsr::hh_mm_ss converted_ra(ra);
  onsr::sdd_mm_ss converted_dec(dec);
...
int onstep_telescope::slew_to_coordinates_async(const double &ra,
                                                 const double &dec) {
  throw_if_not_connected();
  throw_if_parked();
...
int onstep_telescope::slew_to_target() {
  throw_if_not_connected();
  throw_if_parked();
  ...
  auto resp = send_command_to_mount(onst::cmd_goto(), true, '0');
  if (resp == "0") {
    block_while_moving();
    return 0;
  } else {
...
int onstep_telescope::slew_to_target_async() {
  throw_if_not_connected();
  throw_if_parked();
  if (!_ra_target_set || !_dec_target_set)
    throw alpaca_exception(alpaca_exception::INVALID_OPERATION,
...
// TODO: Check if Onstep supports this
int onstep_telescope::sync_to_alt_az(const double &alt, const double &az) {
  throw_if_not_connected();
  throw alpaca_exception(alpaca_exception::NOT_IMPLEMENTED,
...
int onstep_telescope::sync_to_coordinates(const double &ra,
                                           const double &dec) {
  throw_if_not_connected();
  throw_if_parked();
  ...
  auto resp = send_command_to_mount(onst::cmd_sync(), true);
...
int onstep_telescope::sync_to_target() {
  throw_if_not_connected();
  throw_if_parked();
  if (!_ra_target_set || !_dec_target_set)
    throw alpaca_exception(alpaca_exception::INVALID_OPERATION,
